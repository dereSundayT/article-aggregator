...
{
    public function __construct(protected ArticleService $articleService, protected GeneralService $generalService)
    {
    }
    ...
    public function getArticles(GetArticlesRequest $request): JsonResponse
    {
        try {
            //
            $this->generalService->authorizeAction('viewAny', Article::class);
            ...
            return errorResponse($th->getMessage(), $th->getCode());
        }
    }
